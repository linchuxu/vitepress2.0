...
```
解释name: Deploy VitePress site to Pages
...
可以参考视频：https://www.bilibili.com/video/BV1XW4y1w7bc/?spm_id_from=333.1007.top_right_bar_window_history.content.click

转载自: [vitepress搭建并部署网站 | AlbertZhang的文档网站 (bugdesigner.cn)](https://docs.bugdesigner.cn/docs/Tutorial/vitepress.html#使用github-pages部署)
